...
public class AddDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SecAdapter=new ArrayAdapter<>(this,android.R.layout.simple_spinner_item,this.getResources().getStringArray(R.array.Forma_invatamant));
        SecAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        BranchAdapter=new ArrayAdapter<>(this,android.R.layout.simple_spinner_item,this.getResources().getStringArray(R.array.Specializare));
        BranchAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        SemAdapter=new ArrayAdapter<>(this,android.R.layout.simple_spinner_item,this.getResources().getStringArray(R.array.Semestru));
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(name.getText().toString().equals("")&&dataSnapshot.exists()){
                    ...
                    section.setSelection(Arrays.asList(AddDetails.this.getResources()
                            .getStringArray(R.array.Forma_invatamant)).indexOf(user.sect));
                    branch.setSelection(Arrays.asList(AddDetails.this.getResources()
                            .getStringArray(R.array.Specializare)).indexOf(user.branch));
                    sem.setSelection(Arrays.asList(AddDetails.this.getResources()
                            .getStringArray(R.array.Semestru)).indexOf(user.semester));
                }
            }
